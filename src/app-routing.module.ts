...
const ROUTES: Routes = [
  ...
  { path: 'autocomplete-attach-different-element-example', component: DtExampleAutocompleteAttachDifferentElement },
  { path: 'autocomplete-control-values-example', component: DtExampleAutocompleteControlValues },
  { path: 'autocomplete-custom-filter-example', component: DtExampleAutocompleteCustomFilter },
  { path: 'autocomplete-default-example', component: DtExampleAutocompleteDefault },
  { path: 'autocomplete-groups-example', component: DtExampleAutocompleteGroups },
  { path: 'autocomplete-highlight-first-option-example', component: DtExampleAutocompleteHighlightFirstOption },
  { path: 'bar-indicator-alignment-example', component: DtExampleBarIndicatorAlignment },
  { path: 'bar-indicator-color-example', component: DtExampleBarIndicatorColor },
  { path: 'bar-indicator-default-example', component: DtExampleBarIndicatorDefault },
  { path: 'bar-indicator-dynamic-example', component: DtExampleBarIndicatorDynamic },
  { path: 'bar-indicator-table-example', component: DtExampleBarIndicatorTable },
  ...
  { path: 'breadcrumbs-default-example', component: DtExampleBreadcrumbsDefault },
  { path: 'breadcrumbs-observable-example', component: DtExampleBreadcrumbsObservable },
  ...
  { path: 'button-loading-spinner-example', component: DtExampleButtonLoadingSpinner },
  { path: 'button-variant-example', component: DtExampleButtonVariant },
  { path: 'button-group-default-example', component: DtExampleButtonGroupDefault },
  { path: 'button-group-disabled-example', component: DtExampleButtonGroupDisabled },
  { path: 'button-group-error-example', component: DtExampleButtonGroupError },
  { path: 'button-group-interactive-example', component: DtExampleButtonGroupInteractive },
  { path: 'button-group-item-disabled-example', component: DtExampleButtonGroupItemDisabled },
  { path: 'card-action-buttons-example', component: DtExampleCardActionButtons },
  { path: 'card-dark-example', component: DtExampleCardDark },
  { path: 'card-default-example', component: DtExampleCardDefault },
  { path: 'card-footer-actions-example', component: DtExampleCardFooterActions },
  ...
  { path: 'chart-behavior-switch-example', component: DtExampleChartBehaviorSwitch },
  ...
  { path: 'chart-heatfield-multiple-example', component: DtExampleChartHeatfieldMultiple },
  { path: 'chart-line-example', component: DtExampleChartLine },
  { path: 'chart-line-with-gaps-example', component: DtExampleChartLineWithGaps },
  { path: 'chart-loading-example', component: DtExampleChartLoading },
  { path: 'chart-min-max-example', component: DtExampleChartMinMax },
  { path: 'chart-ordered-colors-example', component: DtExampleChartOrderedColors },
  { path: 'chart-pie-example', component: DtExampleChartPie },
  { path: 'chart-selection-area-default-example', component: DtExampleChartSelectionAreaDefault },
  { path: 'chart-single-data-point-example', component: DtExampleChartSinglePointData },
  ...
  { path: 'checkbox-indeterminate-example', component: DtExampleCheckboxIndeterminate },
  { path: 'checkbox-responsive-example', component: DtExampleCheckboxResponsive },
  { path: 'confirmation-dialog-default-example', component: DtExampleConfirmationDialogDefault },
  { path: 'confirmation-dialog-show-backdrop-example', component: DtExampleConfirmationDialogShowBackdrop },
  { path: 'consumption-default-example', component: DtExampleConsumptionDefault },
  { path: 'consumption-error-example', component: DtExampleConsumptionError },
  { path: 'consumption-warning-example', component: DtExampleConsumptionWarning },
  { path: 'container-breakpoint-observer-default-example', component: DtExampleContainerBreakpointObserverDefault },
  { path: 'container-breakpoint-observer-if-else-example', component: DtExampleContainerBreakpointObserverIfElse },
  { path: 'container-breakpoint-observer-if-example', component: DtExampleContainerBreakpointObserverIf },
  { path: 'context-dialog-actions-example', component: DtExampleContextDialogActions },
  { path: 'context-dialog-custom-icon-example', component: DtExampleContextDialogCustomIcon },
  { path: 'context-dialog-dark-example', component: DtExampleContextDialogDark },
  { path: 'context-dialog-default-example', component: DtExampleContextDialogDefault },
  { path: 'context-dialog-header-example', component: DtExampleContextDialogHeader },
  { path: 'context-dialog-interactive-example', component: DtExampleContextDialogInteractive },
  { path: 'context-dialog-previous-focus-example', component: DtExampleContextDialogPreviousFocus },
  { path: 'copy-to-clipboard-callback-example', component: DtExampleCopyToClipboardCallback },
  { path: 'copy-to-clipboard-context-example', component: DtExampleCopyToClipboardContext },
  { path: 'copy-to-clipboard-dark-example', component: DtExampleCopyToClipboardDark },
  { path: 'copy-to-clipboard-default-example', component: DtExampleCopyToClipboardDefault },
  { path: 'copy-to-clipboard-error-example', component: DtExampleCopyToClipboardError },
  { path: 'copy-to-clipboard-secondary-button-example', component: DtExampleCopyToClipboardSecondaryButton },
  { path: 'copy-to-clipboard-textarea-example', component: DtExampleCopyToClipboardTextarea },
  { path: 'cta-card-closable-example', component: DtExampleCtaCardClosable },
  { path: 'cta-card-default-example', component: DtExampleCtaCardDefault },
  ...
  { path: 'empty-state-default-example', component: DtExampleEmptyStateDefault },
  { path: 'empty-state-in-card-example', component: DtExampleEmptyStateInCard },
  { path: 'empty-state-multiple-items-example', component: DtExampleEmptyStateMultipleItems },
  { path: 'empty-state-multiple-items-in-card-example', component: DtExampleEmptyStateMultipleItemsInCard },
  { path: 'event-chart-complex-selection-example', component: DtExampleEventChartComplexSelection },
  { path: 'event-chart-custom-color-example', component: DtExampleEventChartCustomColor },
  { path: 'event-chart-default-example', component: DtExampleEventChartDefault },
  { path: 'event-chart-legend-example', component: DtExampleEventChartLegend },
  { path: 'event-chart-overlapping-load-example', component: DtExampleEventChartOverlappingLoad },
  { path: 'event-chart-overlay-example', component: DtExampleEventChartOverlay },
  { path: 'event-chart-selection-example', component: DtExampleEventChartSelection },
  { path: 'event-chart-session-replay-example', component: DtExampleEventChartSessionReplay },
  { path: 'expandable-panel-default-example', component: DtExampleExpandablePanelDefault },
  { path: 'expandable-panel-disabled-example', component: DtExampleExpandablePanelDisabled },
  { path: 'expandable-panel-dynamic-trigger-example', component: DtExampleExpandablePanelDynamicTrigger },
  { path: 'expandable-panel-programmatic-example', component: DtExampleExpandablePanelProgrammatic },
  { path: 'expandable-section-dark-example', component: DtExampleExpandableSectionDark },
  { path: 'expandable-section-default-example', component: DtExampleExpandableSectionDefault },
  { path: 'expandable-section-disabled-example', component: DtExampleExpandableSectionDisabled },
  { path: 'expandable-section-interactive-example', component: DtExampleExpandableSectionInteractive },
  { path: 'expandable-section-open-example', component: DtExampleExpandableSectionOpen },
  { path: 'expandable-text-default-example', component: DtExampleExpandableTextDefault },
  { path: 'filter-field-async-example', component: DtExampleFilterFieldAsync },
  { path: 'filter-field-clearall-example', component: DtExampleFilterFieldClearall },
  { path: 'filter-field-default-example', component: DtExampleFilterFieldDefault },
  { path: 'filter-field-distinct-example', component: DtExampleFilterFieldDistinct },
  { path: 'filter-field-programmatic-filters-example', component: DtExampleFilterFieldProgrammaticFilters },
  { path: 'filter-field-readonly-non-editable-tags-example', component: DtExampleFilterFieldReadOnlyTags },
  { path: 'filter-field-unique-example', component: DtExampleFilterFieldUnique },
  { path: 'form-field-default-example', component: DtExampleFormFieldDefault },
  { path: 'form-field-error-custom-validator-example', component: DtExampleFormFieldErrorCustomValidator },
  ...
  { path: 'form-field-prefix-suffix-example', component: DtExampleFormFieldPrefixSuffix },
  ...
  { path: 'formatters-time-example', component: DtExampleFormattersTime },
  { path: 'highlight-case-sensitive-example', component: DtExampleHighlightCaseSensitive },
  { path: 'highlight-default-example', component: DtExampleHighlightDefault },
  { path: 'async-icon', component: DtExampleIconAsync },
  ...
  { path: 'inline-editor-default-example', component: DtExampleInlineEditorDefault },
  { path: 'inline-editor-failing-example', component: DtExampleInlineEditorFailing },
  { path: 'inline-editor-required-example', component: DtExampleInlineEditorRequired },
  { path: 'inline-editor-successful-example', component: DtExampleInlineEditorSuccessful },
  { path: 'inline-editor-validation-example', component: DtExampleInlineEditorValidation },
  { path: 'input-dark-example', component: DtExampleInputDark },
  { path: 'input-default-example', component: DtExampleInputDefault },
  { path: 'input-disabled-readonly-example', component: DtExampleInputDisabledReadonly },
  ...
  { path: 'key-value-list-default-example', component: DtExampleKeyValueListDefault },
  { path: 'key-value-list-longtext-example', component: DtExampleKeyValueListLongtext },
  { path: 'key-value-list-multicolumn-example', component: DtExampleKeyValueListMulticolumn },
  { path: 'legend-default-example', component: DtExampleLegendDefault },
  { path: 'legend-overlay-example', component: DtExampleLegendOverlay },
  { path: 'legend-symbol-attribute-example', component: DtExampleLegendSymbolAttribute },
  { path: 'legend-timeline-chart-example', component: DtExampleLegendTimelineChart },
  ...
  { path: 'loading-distractor-default-example', component: DtExampleLoadingDistractorDefault },
  { path: 'loading-distractor-input-example', component: DtExampleLoadingDistractorInput },
  { path: 'loading-distractor-spinner-example', component: DtExampleLoadingDistractorSpinner },
  { path: 'menu-default-example', component: DtExampleMenuDefault },
  { path: 'menu-within-context-dialog-example', component: DtExampleMenuWithinContextDialog },
  { path: 'menu-within-drawer-example', component: DtExampleMenuWithinDrawer },
  { path: 'micro-chart-columns-example', component: DtExampleMicroChartColumns },
  { path: 'micro-chart-columns-interpolated-example', component: DtExampleMicroChartColumnsInterpolated },
  { path: 'micro-chart-default-example', component: DtExampleMicroChartDefault },
  { path: 'micro-chart-interpolated-example', component: DtExampleMicroChartInterpolated },
  { path: 'micro-chart-stream-example', component: DtExampleMicroChartStream },
  { path: 'overlay-complex-content-example', component: DtExampleOverlayComplexContent },
  { path: 'overlay-default-example', component: DtExampleOverlayDefault },
  { path: 'overlay-implicit-context-example', component: DtExampleOverlayImplicitContext },
  { path: 'overlay-programmatic-example', component: DtExampleOverlayProgrammaticDummy },
  { path: 'overlay-programmatic-example', component: DtExampleOverlayProgrammatic },
  ...
  { path: 'pagination-dynamic-table-example', component: DtExamplePaginationDynamicTable },
  { path: 'pagination-many-example', component: DtExamplePaginationMany },
  { path: 'progress-bar-change-example', component: DtExampleProgressBarChange },
  { path: 'progress-bar-dark-example', component: DtExampleProgressBarDark },
  { path: 'progress-bar-default-example', component: DtExampleProgressBarDefault },
  { path: 'progress-bar-right-aligned-example', component: DtExampleProgressBarRightAligned },
  { path: 'progress-bar-with-color-example', component: DtExampleProgressBarWithColor },
  { path: 'progress-bar-with-count-and-description-example', component: DtExampleProgressBarWithCountAndDescription },
  { path: 'progress-bar-with-count-and-description-indicator-example', component: DtExampleProgressBarWithCountAndDescriptionIndicator },
  { path: 'progress-bar-with-count-example', component: DtExampleProgressBarWithCount },
  { path: 'progress-bar-with-description-example', component: DtExampleProgressBarWithDescription },
  { path: 'progress-circle-change-example', component: DtExampleProgressCircleChange },
  { path: 'progress-circle-default-example', component: DtExampleProgressCircleDefault },
  { path: 'progress-circle-with-color-example', component: DtExampleProgressCircleWithColor },
  { path: 'progress-circle-with-icon-example', component: DtExampleProgressCircleWithIcon },
  { path: 'progress-circle-with-text-example', component: DtExampleProgressCircleWithText },
  { path: 'radio-dark-example', component: DtExampleRadioDark },
  { path: 'radio-default-example', component: DtExampleRadioDefault },
  { path: 'radio-name-grouping-example', component: DtExampleRadioNameGrouping },
  { path: 'radio-responsive-example', component: DtExampleRadioResponsive },
  { path: 'secondary-nav-active-example', component: DtExampleSecondaryNavActive },
  { path: 'secondary-nav-default-example', component: DtExampleSecondaryNavDefault },
  { path: 'secondary-nav-expandable-example', component: DtExampleSecondaryNavExpandable },
  { path: 'secondary-nav-external-example', component: DtExampleSecondaryNavExternal },
  { path: 'secondary-nav-multi-example', component: DtExampleSecondaryNavMulti },
  { path: 'secondary-nav-title-example', component: DtExampleSecondaryNavTitle },
  { path: 'select-complex-value-example', component: DtExampleSelectComplexValue },
  ...
  { path: 'table-column-min-width-example', component: DtExampleTableColumnMinWidth },
  { path: 'table-column-proportion-example', component: DtExampleTableColumnProportion },
  { path: 'table-comparators-example', component: DtExampleTableComparators },
  { path: 'table-custom-columns-example', component: DtExampleTableCustomColumns },
  { path: 'table-default-example', component: DtExampleTableDefault },
  { path: 'table-dynamic-columns-example', component: DtExampleTableDynamicColumns },
  { path: 'table-empty-state-example', component: DtExampleTableEmptyState },
  { path: 'table-expandable-rows-example', component: DtExampleTableExpandableRows },
  { path: 'table-favorite-column-example', component: DtExampleTableFavoriteColumn },
  { path: 'table-favorite-column-no-header-example', component: DtExampleTableFavoriteColumnNoHeader },
  { path: 'table-interactive-rows-example', component: DtExampleTableInteractiveRows },
  ...
  { path: 'table-sorting-mixed-columns-example', component: DtExampleTableSortingMixedColumns },
  { path: 'table-sticky-header-example', component: DtExampleTableStickyHeader },
  { path: 'table-with-info-group-cell-example', component: DtExampleTableWithInfoGroupCell },
  ...
  { path: 'tag-list-with-tag-add-example', component: DtExampleTagListWithTagAdd },
  ...
  { path: 'timeline-chart-default-example', component: DtExampleTimelineChartDefault },
  { path: 'timeline-chart-overlay-example', component: DtExampleTimelineChartOverlay },
  ...
  { path: 'toggle-button-group-default-example', component: DtExampleToggleButtonGroupDefault },
  { path: 'toggle-button-group-dynamic-items-example', component: DtExampleToggleButtonGroupDynamicItems },
  { path: 'toggle-button-group-show-more-example', component: DtExampleToggleButtonGroupShowMore },
  { path: 'top-bar-navigation-default-example', component: DtExampleTopBarNavigationDefault },
  { path: 'top-bar-navigation-drawer-example', component: DtExampleTopBarNavigationDrawer },
  { path: 'tree-table-async-show-more-example', component: DtExampleTreeTableAsyncShowMore },
  { path: 'tree-table-default-example', component: DtExampleTreeTableDefault },
  { path: 'tree-table-problem-indicator-example', component: DtExampleTreeTableProblemIndicator },
